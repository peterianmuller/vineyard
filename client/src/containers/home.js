    ...
    return (
      <div style={styles.flexBox}>
        <Segment style={styles.segmentSize}>
          ...
          <p>
            IPhone yuccie health goth helvetica man bun. 
            ...
            umami roof party schlitz, post-ironic shoreditch.
          </p>
        </Segment>
        <Segment style={styles.segmentSize}>
          ...
          <p>
            Disrupt green juice deep v ethical shabby chic, 
            ...
            Art party chillwave yuccie keffiyeh, bitters deep v before they sold out.
          </p>
        </Segment>
        <Segment style={styles.segmentSize}>
